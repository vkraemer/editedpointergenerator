...
# Hyperparameters
tf.flags.DEFINE_integer('hidden_dim', 64, 'dimension of RNN hidden states')
tf.flags.DEFINE_integer('emb_dim', 32, 'dimension of word embeddings')
tf.flags.DEFINE_integer('batch_size', 4, 'minibatch size')
tf.flags.DEFINE_integer('max_enc_steps', 100, 'max timesteps of encoder (max source text tokens)')
tf.flags.DEFINE_integer('max_dec_steps', 25, 'max timesteps of decoder (max summary tokens)')
...
tf.flags.DEFINE_integer('vocab_size', 12500, 'Size of vocabulary. These will be read from the vocabulary file in order. If the vocabulary file contains fewer words than this number, or if this number is set to 0, will take all words in the vocabulary file.')
...
tf.flags.DEFINE_boolean('pointer_gen', False, 'If True, use pointer-generator model. If False, use baseline model.')
